        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-12 mb-12">
          ...
          <div>
            ...
            <ul className="space-y-2">
              <li><Link href="/shopall" className="text-gray-400 hover:text-yellow-400 transition-colors">All Products</Link></li>
              <li><Link href="/winter" className="text-gray-400 hover:text-yellow-400 transition-colors">Winter</Link></li>
              <li><Link href="/summer" className="text-gray-400 hover:text-yellow-400 transition-colors">Summer</Link></li>
              <li><Link href="/dupatta" className="text-gray-400 hover:text-yellow-400 transition-colors">Dupattas</Link></li>
              <li><Link href="/shawl" className="text-gray-400 hover:text-yellow-400 transition-colors">Shawls</Link></li>
            </ul>
          </div>
          
          <div>
            <h4 className="text-yellow-400 font-semibold mb-4 text-lg">Support</h4>
            <ul className="space-y-2">
              ...
              <li><a href="#" className="text-gray-400 hover:text-yellow-400 transition-colors">Returns</a></li>
              <li><a href="#" className="text-gray-400 hover:text-yellow-400 transition-colors">FAQ</a></li>
            </ul>
          </div>
          
          <div>
            <h4 className="text-yellow-400 font-semibold mb-4 text-lg">Connect</h4>
            <ul className="space-y-2">
              ...
              <li><a href="#" className="text-gray-400 hover:text-yellow-400 transition-colors">Pinterest</a></li>
            </ul>
          </div>
        </div>
